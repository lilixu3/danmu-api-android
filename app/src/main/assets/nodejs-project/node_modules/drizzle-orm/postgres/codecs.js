...
import { arrayCompatCast, arrayCompatNormalize, arrayCompatNormalizeInput, castToText, castToTextArr, makeBoxArray, makeGeometryArray, parseGeometryArrayAndNormalize, parseGeometryTuple, parseGeometryXY, parseLineABC, parseLineTuple, parsePgArrayAndNormalize, parsePgVector, parsePointTuple, parsePointXY, refineGenericPgCodecs, textToDate, textToDateWithTz } from "../pg-core/codecs.js";

//#region src/postgres/codecs.ts
const stringifyBigint = (value) => value.toString();
const pgTextToBool = (value) => value === "t" || value === "true";
const pgTextToBuffer = (value) => Buffer.from(value.slice(2), "hex");
const bufferToPgHex = (value) => `\\x${Buffer.from(value).toString("hex")}`;
...
const minipgCodecs = refineGenericPgCodecs({
	smallint: {
...
//#endregion
export { minipgCodecs, minipgShapeCodecs };
