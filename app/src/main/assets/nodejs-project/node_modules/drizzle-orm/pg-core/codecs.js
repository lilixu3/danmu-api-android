...
const parsePgArrayAndNormalize = (normalize, delim) => {
	const codec = arrayCompatNormalize(normalize);
	return (value, arrayDimensions) => codec(parsePgArray(value, delim), arrayDimensions);
};
const parseGeometryArrayAndNormalize = (normalize) => parsePgArrayAndNormalize(normalize, ":");
const makeGeometryArray = (value) => makePgArray(value, ":");
const makeBoxArray = (value) => makePgArray(value, ";");
...
//#endregion
export { arrayCompatCast, arrayCompatNormalize, arrayCompatNormalizeInput, castToText, castToTextArr, genericPgCodecs, makeBoxArray, makeGeometryArray, parseGeometryArrayAndNormalize, parseGeometryTuple, parseGeometryXY, parseLineABC, parseLineTuple, parsePgArrayAndNormalize, parsePgVector, parsePointTuple, parsePointXY, refineGenericPgCodecs, resolvePgTypeAlias, textToDate, textToDateWithTz, unionsTypeTable };
