...
const parsePgArrayAndNormalize = (normalize, delim) => {
	...
	return (value, arrayDimensions) => codec(require_pg_core_array.parsePgArray(value, delim), arrayDimensions);
};
const parseGeometryArrayAndNormalize = (normalize) => parsePgArrayAndNormalize(normalize, ":");
const makeGeometryArray = (value) => require_pg_core_array.makePgArray(value, ":");
const makeBoxArray = (value) => require_pg_core_array.makePgArray(value, ";");
...
exports.makeBoxArray = makeBoxArray;
exports.makeGeometryArray = makeGeometryArray;
exports.parseGeometryArrayAndNormalize = parseGeometryArrayAndNormalize;
