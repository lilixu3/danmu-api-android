...
var MySql2Database = class extends MySqlAsyncDatabase {
	static [entityKind] = "MySql2Database";
};
function construct(client, config = {}) {
	const clientConfig = client.config ?? client.pool?.config ?? client.connection?.config;
...
function drizzle(...params) {
	...
	return construct(typeof connection === "string" ? createPool({ uri: connection }) : createPool(connection), config);
}
(function(_drizzle) {
