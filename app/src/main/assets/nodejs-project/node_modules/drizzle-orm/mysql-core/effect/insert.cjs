...
var MySqlEffectInsertBase = class extends __mysql_core_query_builders_insert_ts.MySqlInsertBase {
	static [__entity_ts.entityKind] = "MySqlEffectInsert";
	/** @internal */
	_prepare() {
...
(0, __effect_core_query_effect_ts.applyEffectWrapper)(MySqlEffectInsertBase);

//#endregion
exports.MySqlEffectInsertBase = MySqlEffectInsertBase;
